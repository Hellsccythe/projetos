...
int main() {
    ...
    //Escolha de atributos para comparação & inicialização de variavel.
    int escolhaAtrib;

    printf("\n\n#### Escolha o Atributo para comparação para que seja determinado o vencedor ####\n");
    printf("Escolha dentre uma das opções:\n");
    printf("1- População\n");
    printf("2- Área\n");
    printf("3- PIB\n");
    ...
    scanf("%d", &escolhaAtrib);

    printf("\n\n***### CIDADES COMPARADAS: %s (CIDADE 1) & %s (CIDADE 2) ###***\n", cidade1, cidade2);
    printf("\n\n***### RESULTADO FINAL ###***\n");
